define({
    root:
        ({
            ...
            manageTitle: "Manage",
            moderateCommentsTitle: "Moderate comments",
            adminSettingsTitle: "Settings",
            analyticsTitle: "Analytics",
            adminToolsTitle: "Migrate, import and export discussions",

            areaSettingsTitle: "Add Disqus on pages in rendering areas",
            areaSettingsDescription: "You can add Disqus comments in the rendering areas defined in your templates. Please see details about client resource rendering in the ${sdkLink}.",
            renderingAreasTitle: "Rendering areas names",
